                    ...
                    <td style="padding: 40px 0px 0px;">
                      <div style="padding: 20px; background-color: rgb(255, 255, 255);">
                        <div style="color: rgb(0, 0, 0); text-align: left;">
                          ...
                          <p style="padding-bottom: 16px; font-size:15px">Thanks,<br>${appName}</p>
                        </div>
                      </div>
                    </td>
                  </tr>
              ...
              <tbody>
                <tr>
                  <td style="padding: 40px 0px 0px;">
                    <div style="padding: 20px; background-color: rgb(255, 255, 255);">
                      <div style="color: rgb(0, 0, 0); text-align: left;">
                        <h1 style="margin: 1rem 0; font-size:30px">${appName}</h1>
              ...
              <tbody>
                <tr>
                  <td style="padding: 40px 0px 0px;">
                    <div style="padding: 20px; background-color: rgb(255, 255, 255);">
                      <div style="color: rgb(0, 0, 0); text-align: left;">
                        <h1 style="margin: 1rem 0; font-size:28px">Welcome to ${appName}</h1>
                        ...
                        <p style="padding-bottom: 16px; font-size:15px">Best regards,<br><span style="color: #999">${appName}</span></p>
                      </div>
                    </div>
